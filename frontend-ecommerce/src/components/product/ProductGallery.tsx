    ...
    <div className="grid gap-3 lg:grid-cols-[72px_minmax(0,1fr)]">
      ...
      <div className="order-2 flex gap-2 overflow-x-auto lg:order-1 lg:flex-col">
        {visibleImages.map((image, index) => {
          ...
          const isThumbRemote = src.startsWith("http://") || src.startsWith("https://");
          return (
            <button
      ...
      {/* Main image */}
      <div className="order-1 relative aspect-[4/5] overflow-hidden rounded-md border border-ink/10 bg-linen lg:order-2">
        {isRemote ? (
          <Image
            src={current}
            alt={title}
